...
public class TestCTAcquisitionParameters extends TestCase {
	...
	public void TestCTAcquisitionParametersConstructor_EqualityWithSomeNullValues() throws Exception {
		...
		CTAcquisitionParameters ctAcquisitionParameters1 = new CTAcquisitionParameters(irradiationEventUID1,scanType,anatomy,exposureTimeInSeconds,scanningLengthInMM,nominalSingleCollimationWidthInMM,nominalTotalCollimationWidthInMM,pitchFactor,kvp,tubeCurrent,tubeCurrentMaximum,null/*exposureTimePerRotation*/);
		CTAcquisitionParameters ctAcquisitionParameters2 = new CTAcquisitionParameters(irradiationEventUID1,scanType,anatomy,exposureTimeInSeconds,scanningLengthInMM,nominalSingleCollimationWidthInMM,nominalTotalCollimationWidthInMM,pitchFactor,kvp,tubeCurrent,tubeCurrentMaximum,null/*exposureTimePerRotation*/);
		CTAcquisitionParameters ctAcquisitionParameters3 = new CTAcquisitionParameters(irradiationEventUID2,scanType,anatomy,exposureTimeInSeconds,scanningLengthInMM,nominalSingleCollimationWidthInMM,nominalTotalCollimationWidthInMM,pitchFactor,kvp,tubeCurrent,tubeCurrentMaximum,null/*exposureTimePerRotation*/);
		...
		CTAcquisitionParameters ctAcquisitionParameters4 = new CTAcquisitionParameters(irradiationEventUID1,scanType,anatomy,exposureTimeInSeconds,scanningLengthInMM,nominalSingleCollimationWidthInMM,nominalTotalCollimationWidthInMM,pitchFactor,kvp,tubeCurrent,tubeCurrentMaximum,exposureTimePerRotation);
		...
		CTAcquisitionParameters ctAcquisitionParameters5 = new CTAcquisitionParameters(irradiationEventUID2,scanType,anatomy,exposureTimeInSeconds,scanningLengthInMM,nominalSingleCollimationWidthInMM,nominalTotalCollimationWidthInMM,pitchFactor,kvp,tubeCurrent,tubeCurrentMaximum,exposureTimePerRotation);
