...
public abstract class DicomDatabaseInformationModel extends DatabaseInformationModel {
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/database/DicomDatabaseInformationModel.java,v 1.24 2011/04/04 14:47:14 dclunie Exp $";
	...
	/***/
	static final String derivedStudyDateTimeColumnName = "PM_STUDYDATETIME";	// needs to be upper case
	/***/
	static final String derivedSeriesDateTimeColumnName = "PM_SERIESDATETIME";	// needs to be upper case
	/***/
	static final String derivedContentDateTimeColumnName = "PM_CONTENTDATETIME";	// needs to be upper case
	/***/
	static final String derivedAcquisitionDateTimeColumnName = "PM_ACQUISITIONDATETIME";	// needs to be upper case
	/***/
	static final String derivedLossyImageCompressionColumnName = "PM_LOSSYIMAGECOMPRESSION";	// needs to be upper case
...
//System.err.println("DicomDatabaseInformationModel.extendInsertStatementStringWithDerivedAttributeValuesForSelectedInformationEntity(): acquisitionDateTime="+acquisitionDateTime);
	...
	public static String getQuotedSingleStringValueOrNull(Attribute a,boolean escapeSpecialCharacters) throws DicomException {
		...
		if (a == null) {
			...
			String sqlType = getSQLTypeFromDicomValueRepresentation(a.getVR());
