...
public class StorageSOPClassSCU extends SOPClass {
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/StorageSOPClassSCU.java,v 1.49 2011/11/01 16:45:24 dclunie Exp $";
...
if (debugLevel > 0) System.err.println("Not opening an association since no instances to send");
		}
	}
