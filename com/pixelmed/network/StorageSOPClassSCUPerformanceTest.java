...
public class StorageSOPClassSCUPerformanceTest extends StorageSOPClassSCU {
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/StorageSOPClassSCUPerformanceTest.java,v 1.11 2011/06/21 17:16:16 dclunie Exp $";
...
if (debugLevel > 0) System.err.println("StorageSOPClassSCUPerformanceTest: storing "+fileName);
			long lengthOfFile = new File(fileName).length();
...
if (debugLevel > 0) System.err.println("adding pair of SOP Class "+affectedSOPClass+" and Transfer Syntax "+inputTransferSyntax);
