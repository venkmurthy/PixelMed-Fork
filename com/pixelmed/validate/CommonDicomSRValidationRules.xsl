...
<xsl:template name="CheckContentItem">
	...
	<xsl:variable name="matchlist" select="child::node()[name() = $valueType and (string-length($cvConceptName) = 0 or (concept/@cv = $cvConceptName and concept/@csd = $csdConceptName))]"/>
