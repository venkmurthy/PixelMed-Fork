...
public class DicomImageViewer extends ApplicationFrame implements 
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/display/DicomImageViewer.java,v 1.225 2012/02/01 23:02:10 dclunie Exp $";
	...
	/***/
	protected void createGUI() { 					// override ApplicationFrame's method to exit on closing
//System.err.println("DicomImageViewer.createGUI()");
...
//System.err.println("DicomImageViewer.WindowAdapter.windowClosing()");
				quit();
			}
		});
...
System.err.println("DicomImageViewer.setCurrentRemoteQuerySelection(): Guessed missing currentRemoteQuerySelectionLevel to be "+currentRemoteQuerySelectionLevel);
	...
	private void setCurrentDatabaseTreeRecordSelection(DatabaseTreeRecord r) { currentDatabaseTreeRecordSelection = r; }
	private DatabaseTreeRecord getCurrentDatabaseTreeRecordSelection() { return currentDatabaseTreeRecordSelection; }
...
//System.err.println("DicomImageViewer.OurDicomDirectoryBrowser.doSomethingMoreWithWhateverWasSelected():");
	...
	private class OurDatabaseTreeBrowser extends DatabaseTreeBrowser {
		...
		protected boolean doSomethingWithSelection(DatabaseTreeRecord selection) {
			setCurrentDatabaseTreeRecordSelection(selection);
...
//System.err.println("DicomImageViewer.purgeFilesAndDatabaseInformation(): removeFromParent instance level "+databaseSelection);
	...
	protected class DatabasePurgeWorker implements Runnable {
		...
		DatabasePurgeWorker(DatabaseTreeRecord databaseSelection) {
	...
	private class DatabasePurgeActionListener implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			try {
				new Thread(new DatabasePurgeWorker(getCurrentDatabaseTreeRecordSelection())).start();
...
//System.err.println("Building GUI ...");
		...
		
		{
...

			{
				...
				displayControlsSubSubPanel.setLayout(new GridLayout(3,1));
