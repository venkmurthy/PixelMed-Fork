...
System.err.println("FlipAsNecessary(): WARNING: flipping vertically but supressing coordinate transform because does not work - check CAD locations, which may be wrong");
	...
	private class BreastExtentFinder {
		...
		BreastExtentFinder(BufferedImage img,String rowOrientation,int minimumPixel,int maximumPixel,boolean isInverted,double spacing) {
...
//System.err.println("BreastExtentFinder: threshold = "+threshold);
			if (isInverted) {
				threshold = maximumPixel - threshold;
