...
public class DemographicAndTechniqueAnnotations {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/display/DemographicAndTechniqueAnnotations.java,v 1.19 2012/02/01 23:02:09 dclunie Exp $";
				...
				for (int f=0; f<numberOfFrames; ++f) {
					...
					while (i.hasNext()) {
						...
						if ( le.sopClassUID == null
						 ...
						 || (le.sopClassUID.equals("XCIMAGE") && (sopClassUID.equals(SOPClass.EnhancedMRImageStorage) || sopClassUID.equals(SOPClass.MRImageStorage)
										       || sopClassUID.equals(SOPClass.EnhancedCTImageStorage) || sopClassUID.equals(SOPClass.CTImageStorage)) )
						 || (le.sopClassUID.equals("XCENH")   && (sopClassUID.equals(SOPClass.EnhancedMRImageStorage) || sopClassUID.equals(SOPClass.EnhancedCTImageStorage)) )
						 || (le.sopClassUID.equals("NOTENH")  && !(sopClassUID.equals(SOPClass.EnhancedMRImageStorage) || sopClassUID.equals(SOPClass.EnhancedCTImageStorage)) )
