...
public class GeometryOfSlice {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/geometry/GeometryOfSlice.java,v 1.16 2011/05/25 14:19:17 dclunie Exp $";
	...
	public final void lookupImageCoordinate(double offsets[],double[] location) {
		double column = ((location[1] - tlhcArray[1]) * (columnArray[0]*voxelSpacingArray[0]) - (location[0] - tlhcArray[0]) * (columnArray[1]*voxelSpacingArray[0]))
			      / (rowArray[1]*voxelSpacingArray[1]*columnArray[0]*voxelSpacingArray[0] - rowArray[0]*voxelSpacingArray[1]*columnArray[1]*voxelSpacingArray[0]);
			      
		double row = (location[1] - tlhcArray[1] - column*rowArray[1]*voxelSpacingArray[1]) / (columnArray[1]*voxelSpacingArray[0]);
