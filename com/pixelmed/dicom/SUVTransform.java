...
public class SUVTransform {
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/SUVTransform.java,v 1.4 2012/02/02 11:55:37 dclunie Exp $";
...
//System.err.println("scaleFactorSUVibw (Female) = "+scaleFactorSUVibw);
		...
		public double getSUVbwValue(int storedValue) {
		...
		public double getSUVbsaValue(int storedValue) {
		...
		public double getSUVlbmValue(int storedValue) {
		...
		public double getSUVibwValue(int storedValue) {
