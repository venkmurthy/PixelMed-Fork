...
public class PixelSpacing {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/PixelSpacing.java,v 1.3 2012/02/01 23:02:09 dclunie Exp $";
	...
	public PixelSpacing(AttributeList list,GeometryOfVolume volumeGeometry,boolean preferCalibratedValue,boolean useMagnificationFactorIfPresent) {
		...
		if (!found) {
			...
			if (!found || (preferCalibratedValue && list.get(TagFromName.PixelSpacing) != null)) {
				...
				spacing = Attribute.getSingleDoubleValueOrDefault(list,TagFromName.PixelSpacing,0);
				if (spacing > 0) {
